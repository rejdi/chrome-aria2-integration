...
//event binding
var e_purgebtn = document.getElementById('purgebtn'),e_downloadbtn = document.getElementById('downloadbtn') , e_addbtn = document.getElementById('addbtn'), e_addtask = document.getElementById("addtask"),
